...
from .utils import convert_path_to_os_specific, get_home_directory, available_species, ensure_user_directory_exists
        ...
        if not any(os.path.isdir(os.path.join(os_specific_path, item)) for item in list_of_files):
            ...
            if request.user.is_authenticated:
                ...
                if not os.path.exists(user_dir_path):
                    ...
                    collect_files += f'<li><a href="{current_user}/">Go to your user directory ({current_user})</a></li>'
            else:
        ...
        if not any(os.path.isdir(os.path.join(os_specific_path, item)) 
            ...
            if available_species_list:
                ...
                for species in available_species_list:
                    collect_files += f'<li><a href="{species}/">{species}</a> [<a href="/species-info/{species}/">Info</a>]</li>'
