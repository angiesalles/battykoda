...
class TaskBatch(models.Model):
    ...
    # Forward reference to DetectionRun fixed (it's defined later in the file)
    detection_run = models.ForeignKey('DetectionRun', on_delete=models.SET_NULL, related_name="task_batches", null=True, blank=True)
...
class DetectionRun(models.Model):
    name = models.CharField(max_length=255)
    segmentation = models.ForeignKey('Segmentation', on_delete=models.CASCADE, related_name="detection_runs")
    created_at = models.DateTimeField(auto_now_add=True)
...
class DetectionResult(models.Model):
    ...
    segment = models.ForeignKey("Segment", on_delete=models.CASCADE, related_name="detection_results")
    created_at = models.DateTimeField(auto_now_add=True)
...
class Segment(models.Model):
    ...
    segmentation = models.ForeignKey('Segmentation', on_delete=models.CASCADE, related_name="segments",
...
class Segmentation(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this is the currently active segmentation for the recording"
    )
