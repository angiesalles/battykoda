...
generate_spectrograms_patch = patch('battycoda_app.models.Task.generate_spectrograms', 
                                    MagicMock(return_value=None))

# Patch import_default_species to return empty list
import_default_species_patch = patch('battycoda_app.utils.import_default_species', 
                                     MagicMock(return_value=[]))

# Patch file operations
file_operations_patch = patch('django.core.files.storage.FileSystemStorage._save', 
                              MagicMock(return_value='test_file.txt'))
